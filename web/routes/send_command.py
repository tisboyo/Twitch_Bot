...
async def post_topic(
    ...
    curl --header "Content-Type: application/json" --request POST --data '{"command":"!topic", "args":["set", "New", "topic"], "silent":false}' http://localhost:5000/send_command?access_token=testKey
    """  # noqa E501
